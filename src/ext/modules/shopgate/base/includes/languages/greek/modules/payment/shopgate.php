...
define('MODULE_PAYMENT_SHOPGATE_TEXT_INFO', '����������� ��� ����� �������� ��� Shopgate.');

define('MODULE_PAYMENT_SHOPGATE_TEXT_EMAIL_FOOTER', "");
define('MODULE_PAYMENT_SHOPGATE_STATUS_TITLE', 'Shopgate module �������� ��������������:');
...
define('MODULE_PAYMENT_SHOPGATE_ORDER_STATUS_ID_TITLE', '���������');
define('MODULE_PAYMENT_SHOPGATE_ORDER_STATUS_ID_DESC', '������� ���������� ��� ����������� ��� ���������� ��� ���� �� module ��:');
define('MODULE_PAYMENT_SHOPGATE_ERROR_READING_LANGUAGES', '������ ���� �� ���������� ��� ��������� �������.');
define('MODULE_PAYMENT_SHOPGATE_ERROR_LOADING_CONFIG', '������ �������� ���������.');
define(
'MODULE_PAYMENT_SHOPGATE_ERROR_SAVING_CONFIG',
    '������ ���� ��� ���������� ��� ���������. ' .
    '�������� ������� ��� ����������� (777) ��� �� ������ ' .
    '&quot;data/configuration&quot; ��� Shopgate plugin.'
);
